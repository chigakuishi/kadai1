...
window.onload = function(){
	...
	game.onload = function(){
		//button関係
		var button = new Button("スタート!", "light");
		button.moveTo(10,50);
		game.rootScene.addChild(button);
		var resetButton = new Button("リセット!", "light");
		resetButton.moveTo(100,0);
		game.rootScene.addChild(resetButton);
		resetButton.ontouchstart = function(){
			location.reload();
		}
		var introButton = new Button("説明", "light");
		introButton.moveTo(10,100);
		game.rootScene.addChild(introButton);
		introButton.ontouchstart = function(){
			location.href="intro.html";
		}
		button.ontouchstart = function(){
			game.rootScene.removeChild(button);
			game.rootScene.removeChild(introButton);
			// 自機の設定
